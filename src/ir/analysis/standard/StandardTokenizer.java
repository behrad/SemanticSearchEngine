 ...
 */
public class StandardTokenizer extends ir.analysis.Tokenizer implements StandardTokenizerConstants {
 ...
 */
  final public ir.analysis.Token next() throws ParseException, IOException {
  Token token = null;
