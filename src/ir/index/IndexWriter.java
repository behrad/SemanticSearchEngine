...
import ir.store.RAMDirectory;
import ir.store.FSDirectory;
import ir.store.Lock;
import ir.store.InputStream;
import ir.store.OutputStream;
...
public class IndexWriter {
  ...
  /**
   * Default value is 1000.  Use <code>ir.writeLockTimeout</code>
   * system property to override.
   */
  public static long WRITE_LOCK_TIMEOUT =
    Integer.parseInt(System.getProperty("ir.writeLockTimeout",
      "1000"));

  /**
   * Default value is 10000.  Use <code>ir.commitLockTimeout</code>
   * system property to override.
   */
  public static long COMMIT_LOCK_TIMEOUT =
    Integer.parseInt(System.getProperty("ir.commitLockTimeout",
      "10000"));
  ...
  /**
   * Default value is 10.  Use <code>ir.mergeFactor</code>
   * system property to override.
   */
  public static final int DEFAULT_MERGE_FACTOR =
    Integer.parseInt(System.getProperty("ir.mergeFactor",
      "10"));

  /**
   * Default value is 10.  Use <code>ir.minMergeDocs</code>
   * system property to override.
   */
  public static final int DEFAULT_MIN_MERGE_DOCS =
    Integer.parseInt(System.getProperty("ir.minMergeDocs",
      "10"));

  /**
   * Default value is {@link Integer#MAX_VALUE}.
   * Use <code>ir.maxMergeDocs</code> system property to override.
   */
  public static final int DEFAULT_MAX_MERGE_DOCS =
    Integer.parseInt(System.getProperty("ir.maxMergeDocs",
      String.valueOf(Integer.MAX_VALUE)));

  /**
   * Default value is 10000.  Use <code>ir.maxFieldLength</code>
   * system property to override.
   */
  public static final int DEFAULT_MAX_FIELD_LENGTH =
    Integer.parseInt(System.getProperty("ir.maxFieldLength",
      "10000"));
  ...
  */
   ...
   * Since Documents are merged in a {@link ir.store.RAMDirectory},
